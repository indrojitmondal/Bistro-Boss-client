 ...
 * 5. create payment intent post on the server and return client secret. install stripe on the server site and get client secret . make sure you used payment method types: ['card']
